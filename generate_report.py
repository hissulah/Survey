...
def generate_jmeter_report():
    """Génère un rapport JMeter à partir des résultats."""
    try:
        ...
        plt.switch_backend('Agg')  # Backend non interactif pour éviter les erreurs
        fig, ax = plt.subplots(figsize=(8, 6))
        
        # Style simplifié compatible
        sns.set_style("whitegrid")
        plt.style.use('ggplot')  # Style alternatif si seaborn pose problème
        
        colors = ['#4CAF50', '#F44336']  # Seulement 2 couleurs nécessaires
